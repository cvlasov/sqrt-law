...
\item Once the costs are computed, the next task is computing the features.
  \begin{itemize}
  \item The original plan was to use \href{http://dde.binghamton.edu/download/ensemble/}{JRM}.
